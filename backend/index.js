...
const launchBrowser = async () => {
  try {
    ...
    // Provide a fallback or skip browser-dependent functionality
    console.warn('Falling back to alternative search method');
    
    // You might want to implement an alternative search method here
